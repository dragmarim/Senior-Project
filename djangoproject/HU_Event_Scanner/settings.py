#Django settings for HU_Event_Scanner project.
...
SECRET_KEY = 'salrv2t-79wb0fy1ix(%bjw9i2@$yr!k9y3!e&sju&m7c7dim*'
...
ROOT_URLCONF = 'HU_Event_Scanner.urls'
...
WSGI_APPLICATION = 'HU_Event_Scanner.wsgi.application'
